...
public class LessBasicAutonomous extends LinearOpMode
{
    ...
    {  //extra variables as needed 
            ...
            public State update()
            {
                 if(lift.getCurrentPosition()>startencoder+1000 ) 
      ...
      public class TurnToStart implements StateMachine.State
      {
            ...
            public State update()
            {
                ...
                telemetry.update();
                if (back_left.getCurrentPosition() < encoderStartR + 2100) 
                {
      ...
      public class DriveOut implements StateMachine.State
      {
            ...
            public State update()
            {
                ...
                telemetry.addData("drive out state",s) ; 
                telemetry.update();
                if (back_left.getCurrentPosition() < encoderStart + 10100) 
                {
                      back_left.setPower(0.4);
                      back_right.setPower(0.4);
                      return this;
      ...
      public class DriveOut1 implements StateMachine.State
      {
            ...
            public State update()
            {
                ...
                telemetry.addData("drive out state",s) ; 
                telemetry.update();
                if (back_left.getCurrentPosition() < encoderStart + 9400) 
                {
                      back_left.setPower(0.4);
                      back_right.setPower(0.4);
                      return this;
